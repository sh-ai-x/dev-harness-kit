...
**55 skills** across 13 categories (50 human-invocable, 5 model-invoked). The full path of each entry is `skills/<dir>/SKILL.md`. Use `find skills -mindepth 2 -maxdepth 2 -name SKILL.md | wc -l` to confirm.
...
| Skill | α | Description |
|---|---|---|
| [`do`](do/SKILL.md) | `state` | Unified intent-to-workflow router with versioned envelopes and bounded context handoffs. |
...
| 18 | [`do`](do/SKILL.md) | `plan` | `state` | human |
| 19 | [`docs-maintenance`](docs-maintenance/SKILL.md) | `audit` | `analysis` | human |
| 20 | [`evaluate`](evaluate/SKILL.md) | `eval` | `enforcement` | human |
| 21 | [`evidence-plan`](evidence-plan/SKILL.md) | `design` | `state` | human |
| 22 | [`gate-select`](gate-select/SKILL.md) | `config` | `state` | human |
| 23 | [`guard-mode`](guard-mode/SKILL.md) | `config` | `state` | human |
| 24 | [`harness-effectiveness`](harness-effectiveness/SKILL.md) | `eval` | `enforcement` | human |
| 25 | [`harness-mode`](harness-mode/SKILL.md) | `config` | `state` | human |
| 26 | [`hook-doctor`](hook-doctor/SKILL.md) | `audit` | `enforcement` | model |
| 27 | [`inspect`](inspect/SKILL.md) | `audit` | `analysis` | human |
| 28 | [`interview`](interview/SKILL.md) | `design` | `enforcement` | human |
| 29 | [`learn`](learn/SKILL.md) | `audit` | `state` | human |
| 30 | [`linear`](linear/SKILL.md) | `config` | `state` | human |
| 31 | [`llm-refresh`](llm-refresh/SKILL.md) | `shortcuts` | `analysis` | human |
| 32 | [`log`](log/SKILL.md) | `shortcuts` | `state` | human |
| 33 | [`maintenance`](maintenance/SKILL.md) | `audit` | `enforcement` | human |
| 34 | [`mode`](mode/SKILL.md) | `mode` | `state` | human |
...
| 38 | [`prune`](prune/SKILL.md) | `build` | `analysis` | human |
| 39 | [`prune-propose`](prune-propose/SKILL.md) | `audit` | `state` | human |
| 40 | [`ralph`](ralph/SKILL.md) | `audit` | `state` | human |
| 41 | [`refactor`](refactor/SKILL.md) | `build` | `analysis` | human |
| 42 | [`research`](research/SKILL.md) | `design` | `enforcement` | human |
| 43 | [`review`](review/SKILL.md) | `review` | `analysis` | human |
| 44 | [`review-local`](review-local/SKILL.md) | `ship` | `state` | human |
| 45 | [`security`](security/SKILL.md) | `security` | `enforcement` | human |
| 46 | [`security-metrics`](security-metrics/SKILL.md) | `security` | `enforcement` | human |
| 47 | [`ship`](ship/SKILL.md) | `ship` | `state` | human |
| 48 | [`skill-usage`](skill-usage/SKILL.md) | `shortcuts` | `analysis` | human |
| 49 | [`sot-harness-writer`](sot-harness-writer/SKILL.md) | `design` | `state` | human |
| 50 | [`status`](status/SKILL.md) | `status` | `state` | human |
| 51 | [`sync-version`](sync-version/SKILL.md) | `config` | `state` | human |
| 52 | [`team`](team/SKILL.md) | `config` | `state` | human |
| 53 | [`token-analyzer`](token-analyzer/SKILL.md) | `audit` | `analysis` | human |
| 54 | [`valuate`](valuate/SKILL.md) | `design` | `enforcement` | model |
| 55 | [`worktree-prune`](worktree-prune/SKILL.md) | `shortcuts` | `state` | human |
