...
# (including bare shell or remote-download-to-shell commands) is rejected and the merge
...
merge_loghooks_into() {
    ...
    # remote-download-to-shell commands and arbitrary rm -rf are rejected here so a poisoned
