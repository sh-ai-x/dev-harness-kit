...
- [`iron-laws.md`](iron-laws.md) — Iron Laws (MUST-8 SSOT). Project invariants; read once before any decision.
- [`guidelines.md`](guidelines.md) — Coding guidelines (Karpathy-style behavioral, abbreviated).
