...
**56 skills** across 14 categories (51 human-invocable, 5 model-invoked). The full path of each entry is `skills/<dir>/SKILL.md`. Use `find skills -mindepth 2 -maxdepth 2 -name SKILL.md | wc -l` to confirm.
...
| [`guard-mode`](guard-mode/SKILL.md) | `state` | Session-scoped on/off toggle for the tdd-guard and worktree-guard hard-block hooks. |
...
| [`proposal`](proposal/SKILL.md) | `state` | 0-arg HTML renderer for design proposals / plans. Renders any docs/proposals/<bucket>/<main>/<sub>.yaml (status auto-routed from YAML `status:`) to a self-contained HTML doc for pre-implementation review, with structure… |
...
| Skill | α | Description |
|---|---|---|
| [`ooo-bridge`](ooo-bridge/SKILL.md) | `enforcement` | Materialize a validated Ouroboros Seed plus execution and evaluation identity into dev-kit hand-offs before proposal, plan, build, or a Ralph retry. |
...
| 13 | [`ci-update`](ci-update/SKILL.md) | `bootstrap` | `state` | human |
...
| 20 | [`evidence-plan`](evidence-plan/SKILL.md) | `design` | `state` | human |
| 21 | [`gate-select`](gate-select/SKILL.md) | `config` | `state` | human |
| 22 | [`guard-mode`](guard-mode/SKILL.md) | `config` | `state` | human |
| 23 | [`harness-effectiveness`](harness-effectiveness/SKILL.md) | `eval` | `enforcement` | human |
| 24 | [`harness-mode`](harness-mode/SKILL.md) | `config` | `state` | human |
| 25 | [`hook-doctor`](hook-doctor/SKILL.md) | `audit` | `enforcement` | model |
| 26 | [`inspect`](inspect/SKILL.md) | `audit` | `analysis` | human |
| 27 | [`interview`](interview/SKILL.md) | `design` | `enforcement` | human |
| 28 | [`learn`](learn/SKILL.md) | `audit` | `state` | human |
| 29 | [`linear`](linear/SKILL.md) | `config` | `state` | human |
| 30 | [`llm-refresh`](llm-refresh/SKILL.md) | `shortcuts` | `analysis` | human |
| 31 | [`log`](log/SKILL.md) | `shortcuts` | `state` | human |
| 32 | [`maintenance`](maintenance/SKILL.md) | `audit` | `enforcement` | human |
| 33 | [`mode`](mode/SKILL.md) | `mode` | `state` | human |
| 34 | [`ooo-bridge`](ooo-bridge/SKILL.md) | `integration` | `enforcement` | human |
| 35 | [`plan`](plan/SKILL.md) | `plan` | `state` | human |
| 36 | [`pr-verify`](pr-verify/SKILL.md) | `ship` | `enforcement` | human |
| 37 | [`proposal`](proposal/SKILL.md) | `design` | `state` | human |
| 38 | [`proposal-orch-issue-pr`](proposal-orch-issue-pr/SKILL.md) | `design` | `state` | human |
| 39 | [`prune`](prune/SKILL.md) | `build` | `analysis` | human |
| 40 | [`prune-propose`](prune-propose/SKILL.md) | `audit` | `state` | human |
| 41 | [`ralph`](ralph/SKILL.md) | `audit` | `state` | human |
| 42 | [`refactor`](refactor/SKILL.md) | `build` | `analysis` | human |
| 43 | [`research`](research/SKILL.md) | `design` | `enforcement` | human |
| 44 | [`review`](review/SKILL.md) | `review` | `analysis` | human |
| 45 | [`review-local`](review-local/SKILL.md) | `ship` | `state` | human |
| 46 | [`security`](security/SKILL.md) | `security` | `enforcement` | human |
| 47 | [`security-metrics`](security-metrics/SKILL.md) | `security` | `enforcement` | human |
| 48 | [`ship`](ship/SKILL.md) | `ship` | `state` | human |
| 49 | [`skill-usage`](skill-usage/SKILL.md) | `shortcuts` | `analysis` | human |
| 50 | [`sot-harness-writer`](sot-harness-writer/SKILL.md) | `design` | `state` | human |
| 51 | [`status`](status/SKILL.md) | `status` | `state` | human |
| 52 | [`sync-version`](sync-version/SKILL.md) | `config` | `state` | human |
| 53 | [`team`](team/SKILL.md) | `config` | `state` | human |
| 54 | [`token-analyzer`](token-analyzer/SKILL.md) | `audit` | `analysis` | human |
| 55 | [`valuate`](valuate/SKILL.md) | `design` | `enforcement` | model |
| 56 | [`worktree-prune`](worktree-prune/SKILL.md) | `shortcuts` | `state` | human |
